...
<h1>攻城策略分析 v3（邻接已校对 · 含我方路线推荐）</h1>
<p>规则见 <b>rules.yaml</b>。怪物难度（个人积分，越易越好刷）：暴食1 &lt; 巨魔2 &lt; 看守者3 &lt; 风暴4 &lt; 章鱼/烈焰/钻头/元素=7。<span class="warn">未计入：首占奖励数值、个人积分公式、8-1（混沌）分数。</span></p>
...
<tr><td>1</td><td>周五首占各自半区全部2级+1座易怪1级；先打暴食/巨魔</td><td>2850 / 2850</td></tr>
<tr><td>2</td><td>换持全部3级+3座易怪2级</td><td>5100 / 5100</td></tr>
<tr><td>3</td><td>换持全部4级+3座3级</td><td>10200 / 10200</td></tr>
<tr><td>4</td><td>5级各5座；<b>西周五必拿 5-8（暴食,易）</b>，东拿 5-9</td><td>18000 / 18000</td></tr>
<tr><td>5</td><td>各占2座6级；东经 6-4 补占 5-8?——按协议 5-8 归西</td><td>30000 / 31200</td></tr>
<tr><td>6</td><td>各取己方7级 → 决战 7-3 + 8-1</td><td>50400+ / 51600+</td></tr>
</table>
<p class="sm">累计（每周3结算日）：西约34.9万、东约35.7万，7-3赢家末周再+约6.1万，总差距&lt;5%。</p>
...
<tr><td>1</td><td>北路首占 1-15(巨魔)→2-8(看守者)→2-16(巨魔)；南路 1-16(暴食)→2-1(看守者)。其余名额拿易怪2级凑分</td><td>两条走廊起手，全易怪，个人积分顺手刷</td></tr>
<tr><td>2</td><td>走廊无必经3级——名额全部用于持有易怪3级刷分（3-6/3-13/3-5/3-12…）</td><td>自由周：刷分+侦察对方走向</td></tr>
<tr><td>3</td><td>北路 2-16→<b>4-12(暴食)</b>；南路 2-1→<b>4-7(暴食)</b>；其余持易怪4级</td><td>站上两个6级环跳板，均为暴食</td></tr>
<tr><td>4</td><td><b>决胜卡位</b>：周五开门 4-12→<b>5-8(暴食)</b>。5-9(章鱼)入口在 4-4/4-6，若对方染指也要抢（我方更强打得起消耗）。其余名额补易怪5级（5-3/5-2/5-7/5-10）</td><td>5-8 = 6-1/6-4/7-3 三重门户；握住它 7级环半开</td></tr>
<tr><td>5</td><td><b>决胜争夺</b>：周五 5-8→6-1(巨魔)、6-4(看守者)；南路 4-7→6-2(暴食)；再 6-1→6-3(章鱼) 或 6-2→5-9 补刀。目标4座6级全拿，至少3座+不让对方碰 5-8/5-9</td><td>6级环全握 = 下周锁死已定局</td></tr>
<tr><td>6</td><td>周五 5-8/6-1→<b>7-3</b>，随即 7-3→<b>7-2</b>（利用7级互通省去打 5-9/6-3 跳板），6-2/6-4→<b>7-1</b>。弃3座5级腾名额，终局持有=9城锁死+1机动。8-1 开放即从任意7级进攻</td><td>3×21600/天 + 独占8-1</td></tr>
</table>
...
<h2>七、待补充</h2>
<p>① 首占奖励数值；② 个人积分公式；③ 8-1 分数与开放时间。改 rules.yaml 后一键重跑（Map/scripts/）。</p>
</body></html>"""
